...
mod tests {
  ...
  impl Trait for Test {
    ...
    type Randomness = randomness_collective_flip::Module<Self>;
  }


  type OwnedKittiesTest = OwnedKittiesList<Test>;
  type OwnedKittiesTest1 = OwnedKitties<Test>;
  ...
  fn owned_kitties_can_append_values() {
    new_test_ext().execute_with(|| {
      ...
      assert_eq!(OwnedKittiesTest1::get(&(0, None)), Some(KittyLinkedItemTest {
        prev: Some(1),
        next: Some(1),
      }));
      ...
      assert_eq!(OwnedKittiesTest1::get(&(0, Some(1))), Some(KittyLinkedItemTest {
        prev: None,
        next: None,
      }));
      ...
      assert_eq!(OwnedKittiesTest1::get(&(0, None)), Some(KittyLinkedItemTest {
        ...
        assert_eq!(OwnedKittiesTest1::get(&(0, Some(2))), Some(KittyLinkedItemTest {
        prev: Some(1),
        next: None,
      }));
      ...
      OwnedKittiesTest::append(&0, 3);
        ...
        assert_eq!(OwnedKittiesTest1::get(&(0, Some(3))), Some(KittyLinkedItemTest {
        prev: Some(2),
        next: None,
      }));
  ...
  fn owned_kitties_can_remove_values() {
    new_test_ext().execute_with(|| {
      ...
      assert_eq!(OwnedKittiesTest1::get(&(0, None)), Some(KittyLinkedItemTest {
        ...
        assert_eq!(OwnedKittiesTest1::get(&(0, Some(2))), None);
      ...
      OwnedKittiesTest::remove(&0, 1);
        ...
        assert_eq!(OwnedKittiesTest1::get(&(0, Some(1))), None);
